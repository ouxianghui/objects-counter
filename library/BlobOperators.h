...
class CBlobGetRectArea : public COperadorBlob
{
public:
    double operator()(CBlob &blob)
    {
    ...
    const char *GetNom()
    {
        return "CBlobGetRectArea";
    }
};

//! ouxh add 20160927
class CBlobGetMinEnclosingCircleAreaRatio : public COperadorBlob
{
public:
    double operator()(CBlob &blob)
    {
        ...
        cv::minEnclosingCircle(contour->GetContourPoints(), center, radius);
        double circleArea = 3.14159265 * radius * radius;
        return blob.Area()/circleArea;
    }
    const char *GetNom()
    {
        return "CBlobGetCircleAreaRatio";
    }
};
