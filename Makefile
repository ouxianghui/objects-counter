# http://ken8341.blog.163.com/blog/static/2177720442014111141239309/
# http://ldc.usb.ve/~vtheok/cursos/ci2126/sd10/practicas/code7/Makefile
# 好东西毫无保留拿出来分享，保留作者的GPL信息，这是GNU世界的基本精神！！
...
COMMON+= -DOPENCV
CFLAGS+= -DOPENCV
LDFLAGS+= -L/home/android/CrossCompile/build/lib -lopencv_core -lopencv_highgui -lopencv_imgproc 
COMMON+= -I/home/android/CrossCompile/build/include 
endif

# The pre-processor and compiler options.
# MY_CFLAGS = -ggdb3 -pipe -O2 -Wall -Wextra -fopenmp -march=native -mfpmath=sse -DLINUX -m64 -std=c++0x
MY_CFLAGS += -g -Wall -DLINUX -O2

# The linker options.
# MY_LIBS   = -lGLEW -lglut -lGLU -lGL -lX11 -lXmu -lXi -lm -L/usr/X11R6/lib -lgomp -lOpenThreads -lpthread
MY_LIBS += -lm -lpthread -ldl -lrt -L/home/android/CrossCompile/build/lib -lconfig 
...
INCDIRS = . ./cvBlob ./library

# The directories in which source files reside.
# If not specified, only the current directory will be serached.
SRCDIRS = . ./cvBlob ./library
...
STRIP=RANLIB=arm-linux-gnueabihf-strip  
